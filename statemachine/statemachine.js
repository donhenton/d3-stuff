...
//https://gist.github.com/lgersman/5311202 !!!!!
...
function restart() {
    gStatesData = window.gStates.data(states);

    var gState = gStatesData.enter()
            .append("g")
            .attr({
